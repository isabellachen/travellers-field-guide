  ...
  <div id="page" class="site">
    ...
    <header id="masthead" class="site-header">
      ...
      <div class="site-branding">
        <?php
        the_custom_logo();
        $travellers_field_guide_description = get_bloginfo('description', 'display');
        if ($travellers_field_guide_description || is_customize_preview()) :
        ?>
          <p class="site-description"><?php echo $travellers_field_guide_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                                      ?></p>
        <?php endif; ?>
      </div><!-- .site-branding -->
