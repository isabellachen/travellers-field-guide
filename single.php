...
<main id="primary" class="site-main container">
  ...
  <div id="relatedPosts" class="owl-carousel-wrapper">
    <div class="container position-relative">
      ...
      <h2 class="owl-carousel-heading heading page-h2 border-bottom-none">Explore more stories from <a href="<?php echo $post_category_url ?>"><?php echo $post_category_title ?></a></h2>
